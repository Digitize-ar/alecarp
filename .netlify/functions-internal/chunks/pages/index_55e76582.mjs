...
import 'html-escaper';
import 'clsx';
import { $ as $$Layout } from './galeria_67c00251.mjs';
...
function CardImg() {
  return /* @__PURE__ */ jsxs(Card, { className: "py-4", children: [
    ...
    /* @__PURE__ */ jsx(CardBody, { className: "overflow-visible py-2", children: /* @__PURE__ */ jsx("img", { src: ".././public/img-home2.jpg", alt: "", className: "rounded-lg" }) })
  ] });
}
...
}, "C:/Users/lauty/OneDrive/Documentos/GitHub/alecarp/alecarp-astro-web/src/pages/index.astro", void 0);

const $$file = "C:/Users/lauty/OneDrive/Documentos/GitHub/alecarp/alecarp-astro-web/src/pages/index.astro";
const $$url = "";
