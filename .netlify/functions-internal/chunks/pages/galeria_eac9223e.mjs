...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"><head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.png"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head><body class="h-screen"><header class="bg-white"><nav class="flex justify-between items-center w-[92%]  mx-auto "><div class="flex"><img class="w-16 p-2 cursor-pointer" src="/logo-snl.png" alt="..."><p class="font-bold text-inherit text-3xl m-4">Alecarp</p></div><div class="nav-links duration-500 md:static absolute bg-white md:min-h-fit min-h-[60vh] left-0 z-30 top-[-100%] md:w-auto  w-full flex items-center px-5 mt-0"><ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8"><li><a class="hover:text-gray-500" href="/">Inicio</a></li><li><a class="hover:text-gray-500" href="/servicios">Servicios</a></li><li><a class="hover:text-gray-500" href="/galeria">Galeria</a></li></ul></div><div class="flex items-center gap-6">${renderComponent($$result, "ModalContact", App$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Users/lauty/OneDrive/Documentos/GitHub/alecarp/alecarp-astro-web/alecarp/src/components/ContactModal", "client:component-export": "default" })}<button data-toggle-menu-button class="text-3xl cursor-pointer md:hidden">${renderComponent($$result, "FontAwesomeIcon", FontAwesomeIcon, { "icon": faBars, "width": 30, "color": "#293241" })}</button></div></nav></header>${renderSlot($$result, $$slots["default"])}<footer class="flex flex-col space-y-10 justify-center m-10"><nav class="flex justify-center flex-wrap gap-6 text-gray-500 font-medium"><a class="hover:text-gray-900" href="/">Inicio</a><a class="hover:text-gray-900" href="/servicios">Servicios</a><a class="hover:text-gray-900" href="/galeria">Galeria</a></nav><div class="flex justify-center space-x-5"><a href="https://www.facebook.com/alecarp.muebles" target="_blank" rel="noopener noreferrer"><img src="https://img.icons8.com/fluent/30/000000/facebook-new.png"></a><a href="https://www.instagram.com/alecarp_1971/" target="_blank" rel="noopener noreferrer"><img src="https://img.icons8.com/fluent/30/000000/instagram-new.png"></a></div><p class="text-center text-gray-700 font-medium">©Copyright Alecarp. Diseño y desarrollo by <a href="https://digitize-web.netlify.app">Digitize</a>.</p></footer></body></html>`;
}, "C:/Users/lauty/OneDrive/Documentos/GitHub/alecarp/alecarp-astro-web/alecarp/src/layouts/Layout.astro", void 0);
...
function App() {
  return /* @__PURE__ */ jsx("div", { className: "flex justify-around items-center flex-col md:flex-row", children: cardData.map((data, index) => /* @__PURE__ */ jsxs(Card, { className: "py-4 w-max mb-5 max-h-fit", children: [
...
}, "C:/Users/lauty/OneDrive/Documentos/GitHub/alecarp/alecarp-astro-web/alecarp/src/pages/galeria.astro", void 0);

const $$file = "C:/Users/lauty/OneDrive/Documentos/GitHub/alecarp/alecarp-astro-web/alecarp/src/pages/galeria.astro";
const $$url = "/galeria";
